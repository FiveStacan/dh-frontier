...
internal sealed class DHMappingClientSideSetupCommand : LocalizedEntityCommands
{
    ...
    public override string Command => "DHmappingclientsidesetup";
    ...
    public override void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        _actionSystem.LoadActionAssignments("Prototypes/_DH/mapping_actions.yml", false);
    }
}
