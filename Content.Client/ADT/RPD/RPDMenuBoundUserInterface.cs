...
public sealed class RPDMenuBoundUserInterface : BoundUserInterface
{
    ...
    private static readonly Dictionary<string, (string Tooltip, SpriteSpecifier Sprite)> PrototypesGroupingInfo
        ...
        {
            ["DisposalPipe"] = ("rpd-component-DisposalPipe", new SpriteSpecifier.Texture(new ResPath("/Textures/_DH/Interface/Radial/RPD/DisposalPipe.png"))),
            ["Gaspipes"] = ("rpd-component-Gaspipes", new SpriteSpecifier.Texture(new ResPath("/Textures/_DH/Interface/Radial/RPD/Gaspipes.png"))),
            ["Devices"] = ("rpd-component-Devices", new SpriteSpecifier.Texture(new ResPath("/Textures/_DH/Interface/Radial/RPD/Devices.png"))),
        };
