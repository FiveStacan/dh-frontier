...
public sealed partial class DHTimedSpawnerComponent : Component, ISerializationHooks
{
    [DataField]
    public bool RandomCount { get; set; } = false;
    /// <summary>
    ...
    // Новый поля для поддержки таблицы
    [DataField]
    public bool UseTable = false; // Использовать ли таблицу

    [DataField(required: false)]
    public EntityTableSelector Table = default!; // Таблица для спавна

    // В случае использования таблицы, можно задать Offset для рассеивания
    [DataField]
